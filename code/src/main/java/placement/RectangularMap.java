...
public class RectangularMap extends Map
{
    ...
    public int[] neighbours(int table, int[] dispo)
    {
        ...
        if (neighboursId[0] != -1)
        {
            neighboursId[0] = dispo[table - width - 1] - 1;
        }
        if (neighboursId[1] != -1)
        {
            neighboursId[1] = dispo[table - width] - 1;
        }
        if (neighboursId[2] != -1)
        {
            neighboursId[2] = dispo[table - width + 1] - 1;
        }
        if (neighboursId[3] != -1)
        {
            neighboursId[3] = dispo[table - 1] - 1;
        }
        if (neighboursId[4] != -1)
        {
            neighboursId[4] = dispo[table + 1] - 1;
        }
        if (neighboursId[5] != -1)
        {
            neighboursId[5] = dispo[table + width - 1] - 1;
        }
        if (neighboursId[6] != -1)
        {
            neighboursId[6] = dispo[table + width] - 1;
        }
        if (neighboursId[7] != -1)
        {
            neighboursId[7] = dispo[table + width + 1] - 1;
        }
